...
from custom_components.tekbrox.coordinator import LockState, LockUpdateCoordinator
from custom_components.tekbrox.models import PassageModeConfig, WebhookEvent
