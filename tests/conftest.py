"""Global fixtures for tekbrox integration."""
...
from custom_components.tekbrox.api import TTLockApi
from custom_components.tekbrox.const import DOMAIN
from custom_components.tekbrox.coordinator import LockUpdateCoordinator
from custom_components.tekbrox.models import Lock, LockState, PassageModeConfig
...
def sane_default_data():
    ...
    with patch(
        "custom_components.tekbrox.api.TTLockApi.get_locks", return_value=[lock.id]
    ), patch(
        "custom_components.tekbrox.api.TTLockApi.get_lock", return_value=lock
    ), patch(
        "custom_components.tekbrox.api.TTLockApi.get_lock_state", return_value=state
    ), patch(
        "custom_components.tekbrox.api.TTLockApi.get_lock_passage_mode_config",
