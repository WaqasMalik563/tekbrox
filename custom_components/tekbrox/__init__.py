...
def setup(hass: HomeAssistant, config: ConfigEntry) -> bool:
    """Set up the Brafalocks component."""
...
async def async_setup_entry(hass: HomeAssistant, entry: ConfigEntry) -> bool:
    """Set up Brafalocks from a config entry."""
    implementation = (
...
class WebhookHandler:
    ...
    def async_show_setup_message(self, uri: str) -> None:
        ...
        persistent_notification.async_create(
            self.hass, f"Webhook url: {uri}", "Brafalocks Setup", self.entry.entry_id
        )
